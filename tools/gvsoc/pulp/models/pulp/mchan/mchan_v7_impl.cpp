...
private:
  ...
  static void check_queue_handler(void *_this, std::shared_ptr<vp::clock_event> event);
  static void check_ext_read_handler(void *_this, std::shared_ptr<vp::clock_event> event);
  static void check_ext_write_handler(void *_this, std::shared_ptr<vp::clock_event> event);
  static void check_loc_transfer_handler(void *_this, std::shared_ptr<vp::clock_event> event);
  ...
  std::shared_ptr<vp::clock_event> check_queue_event;
  std::shared_ptr<vp::clock_event> check_ext_read_event;
  std::shared_ptr<vp::clock_event> check_ext_write_event;
  std::shared_ptr<vp::clock_event> check_loc_transfer_event;
...
void mchan::check_ext_read_handler(void *__this, std::shared_ptr<vp::clock_event> event)
{
  mchan *_this = (mchan *)__this;
...
void mchan::check_ext_write_handler(void *__this, std::shared_ptr<vp::clock_event> event)
{
  mchan *_this = (mchan *)__this;
...
void mchan::check_loc_transfer_handler(void *__this, std::shared_ptr<vp::clock_event> event)
{
  mchan *_this = (mchan *)__this;
...
void mchan::check_queue_handler(void *__this, std::shared_ptr<vp::clock_event> event)
{
  mchan *_this = (mchan *)__this;
