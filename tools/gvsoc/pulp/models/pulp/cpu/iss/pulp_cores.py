...
class Pulp_core(Riscv_core):

    def __init__(self):
        super(Pulp_core, self).__init__()
...
class Pulp_cluster_core(Pulp_core):

    def __init__(self):
        
        super(Pulp_cluster_core, self).__init__()
...
class Pulp_fc_core(Pulp_core):

    def __init__(self):
        
        super(Pulp_fc_core, self).__init__()
