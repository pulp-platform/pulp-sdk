...
import runner.chips.siracusa
import os


class Runner(runner.rtl.rtl_runner.Runner, runner.chips.siracusa.Runner):

    def __init__(self, args, config):
        runner.rtl.rtl_runner.Runner.__init__(self, args, config)
        runner.chips.siracusa.Runner.__init__(self, args, config)
