...
import runner.chips.pulpissimo
import os


class Runner(runner.rtl.rtl_runner.Runner, runner.chips.pulpissimo.Runner):

    def __init__(self, args, config):
        runner.rtl.rtl_runner.Runner.__init__(self, args, config)
        runner.chips.pulpissimo.Runner.__init__(self, args, config)
