...
void __attribute__ ((noinline)) layerConvBNRelu24L3(void *args) 
{
  ...
  L2_weights_1 = l2_W;
  L2_weights_2 = l2_W + 16384 + 128 + 128;
  ...
  if(pi_core_id()==0)
  {
    ...
    pi_cl_ram_read(hyperram, l3_W+524288, transfer_weights + 16384, 128, &buff_req_w2);
    pi_cl_ram_read(hyperram, l3_W+528384, transfer_weights + 16384 + 128, 128, &buff_req_w3);
  ...
  for(int k=0; k<32; k++) 
  {
    if (k < 31) 
    {
      if(pi_core_id()==0) 
      {
        ...
        pi_cl_ram_read(hyperram, l3_W+524288+ (k+1)*128, transfer_weights + 16384, 128, &buff_req_w2);
        pi_cl_ram_read(hyperram, l3_W+528384 + (k+1)*128, transfer_weights + 16384+ 128, 128, &buff_req_w3);
      }
    }  
