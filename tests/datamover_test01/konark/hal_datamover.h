...
#define DATAMOVER_REG_MATRIX_DIM_OFFSET       0x30  // [31:16] matrix_dim_n; [15:0] matrix_dim_m
#define DATAMOVER_REG_CTRL_ENGINE_OFFSET      0x34  // [15:12] write_dim_en; [11:8] read_dim_en; [7:3] datamover_mode; [2:0] transp_mode (LSB: 000=none, 001=1 elem, 010=2 elem, 100=4 elem)  // ToDo(cdurrer): pass datamover_mode to HW
...
typedef enum {
  DATAMOVER_FP16    = 0x2,
  DATAMOVER_FP8     = 0x3,
  DATAMOVER_FP16ALT = 0x4,
  DATAMOVER_FP8ALT  = 0x5
} datamover_fp_format_t;

/////////////
// Defines //
/////////////

#define __HAL_DATAMOVER_VERBOSE 0

#if __HAL_DATAMOVER_VERBOSE
...
datamover_status_t datamover_cim_layout_transpose(uint8_t *matrix_in, uint8_t *matrix_out, uint32_t size_m, uint32_t size_n, uint32_t row_tile_size, datamover_transp_mode_t transp_mode);
