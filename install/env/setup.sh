...
export PULPOS_HOME=$PULP_SDK_HOME/install/pulpos
export PULPOS_GAP8_HOME=$PULP_SDK_HOME/install/pulpos_gap8
export PULPOS_MODULES=$PULPOS_GAP8_HOME
export PULPOS_ARCHI=$PULP_SDK_HOME/install
export PULPOS_HAL=$PULP_SDK_HOME/install
export PMSIS_API=$PULP_SDK_HOME/install