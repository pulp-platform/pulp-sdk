...
/* contains number of cores [31:16] and clusters [15:0] */
#define APB_SOC_INFO_OFFSET 0x00
/* not used at the moment */
#define APB_SOC_INFOEXTD_OFFSET 0x04
/* not used at the moment */
#define APB_SOC_NOTUSED0_OFFSET 0x08
/* not used at the moment */
...
/* sets the mux for pins  g*16+0 (bits [1:0]) to g*16+15 (bits [31:30]) */
#define APB_SOC_PADFUN_OFFSET(g)   (APB_SOC_PADFUN0_OFFSET + (g)*4)
...
/* sets config for pin  g*4+0(bits [7:0]) to pin  g*4+3(bits [31:24]) */
#define APB_SOC_PADCFG_OFFSET(g)   (APB_SOC_PADCFG0_OFFSET + (g)*4)
...
/* configures power modes(not funtional yet) */
#define APB_SOC_PWRCFG_OFFSET 0x64
/* 32 bit GP register used by power pngmt routines to see if is hard or cold
 * reboot */
#define APB_SOC_PWRREG_OFFSET 0x68
/* not used at the moment */
#define APB_SOC_BUSY_OFFSET 0x6C
/* memory margin pins(not used at the moment) */
#define APB_SOC_MMARGIN_OFFSET 0x70
/*  R/W register for interaction with the the chip environment */
#define APB_SOC_JTAG_REG 0x74
/* memory margin pins(not used at the moment) */
#define APB_SOC_L2_SLEEP_OFFSET 0x78
/* not used at the moment */
#define APB_SOC_NOTUSED3_OFFSET 0x7C
/* soc clock divider(to be removed) */
#define APB_SOC_CLKDIV0_OFFSET 0x80
/* cluster clock divider(to be removed) */
#define APB_SOC_CLKDIV1_OFFSET 0x84
/* not used at the moment */
#define APB_SOC_CLKDIV2_OFFSET 0x88
/* not used at the moment */
#define APB_SOC_CLKDIV3_OFFSET 0x8C
/* not used at the moment */
#define APB_SOC_CLKDIV4_OFFSET 0x90
/* not used at the moment */
#define APB_SOC_NOTUSED4_OFFSET 0x94
/* not used at the moment */
#define APB_SOC_NOTUSED5_OFFSET 0x98
/* not used at the moment */
#define APB_SOC_NOTUSED6_OFFSET 0x9C
/* 32bit GP register to be used during testing to return EOC(bit[31]) and
 * status(bit[30:0]) */
