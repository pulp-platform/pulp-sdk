...
#define PULP_CHIP CHIP_KRAKEN
#define PULP_CHIP_FAMILY CHIP_KRAKEN
// TODO: should this be CONFIG_KRAKEN??
#define CONFIG_PULP 1
#define PULP_CHIP_STR kraken
#define PULP_CHIP_FAMILY_STR kraken
