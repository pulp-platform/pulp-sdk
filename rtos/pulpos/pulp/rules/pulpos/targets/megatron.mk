...
PULP_CFLAGS    += -fdata-sections -ffunction-sections -include pos/chips/megatron/config.h -I$(PULPOS_PULP_HOME)/include/pos/chips/megatron -I$(PULP_EXT_LIBS)/include
ifeq '$(CONFIG_OPENMP)' '1'
PULP_CFLAGS    += -fopenmp -mnativeomp
endif
PULP_LDFLAGS += -nostartfiles -nostdlib -Wl,--gc-sections -L$(PULP_EXT_LIBS) -L$(PULPOS_PULP_HOME)/kernel -Tchips/megatron/link.ld -lgcc
...
PULP_SRCS     += kernel/chips/megatron/soc.c
