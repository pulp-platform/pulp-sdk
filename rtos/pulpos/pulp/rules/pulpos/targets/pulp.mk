...
PULP_ARCH_CFLAGS ?=   -target riscv32-unknown-elf -march=rv32imfcxpulpv2 -mabi=ilp32f -mno-relax
PULP_ARCH_LDFLAGS ?=  -target riscv32-unknown-elf -march=rv32imfcxpulpv2 -mabi=ilp32f 
...
PULP_LDFLAGS += -nostartfiles -Wl,--gc-sections -L$(PULP_EXT_LIBS) -L$(PULPOS_PULP_HOME)/kernel -Tchips/pulp/link.ld
ifndef PULP_RISCV_LLVM_TOOLCHAIN
PULP_LDFLAGS += -lgcc -nostdlib
endif 
