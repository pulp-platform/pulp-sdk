...
#ifndef __ARCHI_CHIPS_MEGATRON_MEMORY_MAP_H__
#define __ARCHI_CHIPS_MEGATRON_MEMORY_MAP_H__
...
#define ARCHI_PCM_HWPE_OFFSET            0x00001000
#define ARCHI_SOFTEX_OFFSET              0x00001100
...
#define ARCHI_PCM_HWPE_ADDR                        ( ARCHI_CLUSTER_PERIPHERALS_ADDR + ARCHI_PCM_HWPE_OFFSET )
#define ARCHI_SOFTEX_ADDR                          ( ARCHI_CLUSTER_PERIPHERALS_ADDR + ARCHI_SOFTEX_OFFSET )
