...
#ifndef __ARCHI_CHIPS_KRAKEN_MEMORY_MAP_H__
#define __ARCHI_CHIPS_KRAKEN_MEMORY_MAP_H__
 ...
 * POWER MANAGER
 */
#define ARCHI_PM_ADDR                0x1b010000
...
// GEORGR HACK: EU NEEDS TO BE DEMUXED WITH ALIASED ADDRESSES!?
#define ARCHI_CLUSTER_ALIAS_ADDR        0x00000000
...
//GEORGR HACK - PERIPHERAL DEMUXING DOES NOT WORK LIKE IMPLIED ABOVE;
//ADDRESSES STARTING WITH 0x10204000 ALL GET ROUTED TO EU
#define ARCHI_MCHAN_DEMUX_OFFSET (-10240)


#define ARCHI_DEMUX_PERIPHERALS_ADDR          ( ARCHI_CLUSTER_ADDR + ARCHI_DEMUX_PERIPHERALS_OFFSET )
#define ARCHI_DEMUX_PERIPHERALS_ALIAS_ADDR    ( ARCHI_CLUSTER_ALIAS_ADDR + ARCHI_DEMUX_PERIPHERALS_OFFSET )

#define ARCHI_EU_DEMUX_ADDR                   ( ARCHI_DEMUX_PERIPHERALS_ALIAS_ADDR + ARCHI_EU_DEMUX_OFFSET )
