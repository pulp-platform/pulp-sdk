...
extern omp_t PI_CL_L1_TINY ompData;
extern PI_CL_L1_TINY int core_epoch[16];
...
static inline __attribute__((always_inline)) void sectionInitSingle(unsigned int count)
{
  omp_team_t *team = getCurrentTeam();	
  team->loop_is_setup = 1;
  team->loop_start = 1;
