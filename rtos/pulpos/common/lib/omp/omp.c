...
omp_t PI_CL_L1_TINY ompData;
PI_CL_L1_TINY int core_epoch[16];
...
static void __rt_omp_init(int exec_main)
{
  ...
  unsigned int cid = pi_cluster_id();
  unsigned int nbCores = pi_cl_cluster_nb_cores();
...
PI_CL_L1_TINY unsigned int parallelTemp0;
