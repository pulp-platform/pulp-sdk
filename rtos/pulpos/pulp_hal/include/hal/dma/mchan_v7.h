...
#define DMA_WRITE(value, offset) __WRITE_BASE_OFF_VOL((value), (int *)ARCHI_MCHAN_EXT_ADDR, (offset))
#define DMA_READ(offset) __READ_BASE_OFF_VOL((int *)ARCHI_MCHAN_EXT_ADDR, (offset))
#else
